...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (botoesEditarForn && modalEditarForn) {
    botoesEditarForn.forEach((botao) => {
      botao.addEventListener("click", () => {
        document.getElementById("edit_forn_id").value =
          botao.getAttribute("data-id");
        document.getElementById("edit_forn_polo").value =
          botao.getAttribute("data-polo");
        document.getElementById("edit_forn_razao").value =
          botao.getAttribute("data-razao");
        document.getElementById("edit_forn_fantasia").value =
          botao.getAttribute("data-fantasia");
        document.getElementById("edit_forn_cnpj").value =
